    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbPermissions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrgentSurchargeFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Receptionists_Specializations_SpecializationId",
                        column: x => x.SpecializationId,
                        principalTable: "Specializations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecializationSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecializationSchedules_Specializations_SpecializationId",
                        column: x => x.SpecializationId,
                        principalTable: "Specializations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbRolePermissions", x => new { x.RoleId, x.PermissionId });
                    table.ForeignKey(
                        name: "FK_TbRolePermissions_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TbRolePermissions_TbPermissions_PermissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OtpVerifications_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResultUploadedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_Doctor_Date_Period",
                table: "Appointments",
                columns: new[] { "DoctorId", "AppointmentDate", "Period" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_Queue_Unique",
                table: "Appointments",
                columns: new[] { "DoctorId", "AppointmentDate", "Period", "QueueNumber" },
                unique: true,
                filter: "[QueueNumber] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_QueuedAt",
                table: "Appointments",
                column: "QueuedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorAvailabilities_Doctor_Day_Period",
                table: "DoctorAvailabilities",
                columns: new[] { "DoctorId", "DayOfWeek", "Period" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpVerifications_AppointmentId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "OtpVerifications",
                columns: new[] { "Phone", "Purpose", "IsConsumed" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_PhoneNumber_IsDeleted",
                table: "Patients",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Receptionists_SpecializationId",
                table: "Receptionists",
                column: "SpecializationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TbPermissions_Name",
                table: "TbPermissions",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TbRolePermissions_PermissionId",
                table: "TbRolePermissions",
                column: "PermissionId");
